...
def parse_n_prepare(flags):
    ...
    use_locality = train_config['locality'][0]['use_locality']
    load_weight = train_config['locality'][1]['load_weight']
    dataset = train_config['locality'][2]['dataset']
    ...
    return train_params,train_phases,train_data,arch_gcn,use_locality,load_weight,dataset
